...
public class NextActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap = map;//구글 맵 객체 추가
        mMap.addMarker(new MarkerOptions().position(INHA).title("Marker in INHA")); //오호관 포인트 마커 추가
    ...
    public void overlaySetBuilding() {
        ...
        GroundOverlayOptions fifthFirstMap = new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.mipmap.fifth_building)) //만든이미지 res/mipmap에 추가함
